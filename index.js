...
console.log('task 1b:', createMenuItem('waffles', 11, 'breakfast'));
console.log('task 1b:', createMenuItem('apple juice', 2, 'drinks'));
...
function addReview(array, name, rating, feedback){
  return (reviews.push(`${array[name]} 'Daniela', ${array[rating]} 5, ${array[feedback]}: 'Beautiful atmosphere and wonderful vegan options!`));
}
